...
# %%
# Get the phrase nodes that contain specific word 
word_node = 127311 # 3 John 1:4
# word_node = 127377 # 3 John 1:9
phrase_nodes = GNT.api.L.u(word_node, otype='phrase')
print(f"Phrase IDs containing word {word_node}:")
