...
def convertTaskCustom(self):
    ...
    *   Clause and phrase nodes have been added, they duplicate some of the `wg`
    ...
    generic["author"] = "LXX Writers" #information about the authors and the version of the datasource
    generic["editors"] = ""
    generic["title"] = "LXX [...]"
    ...
    generic["converters"] = "Sergey Panfilov, Saulo de Oliveira Cantanhêde, Tony Jurg, Dirk Roorda"
    generic["converterSourceLocation"] = "https://github.com/sergeypanfilov[tobecreated]/tflxx[tobecreated]/tree/main/programs"
    generic["converterVersion"] = "1.0.0 (February 21, 2025)"
    generic["dataSourceFormat"] = "XML lowfat tree data"
    generic["dataSource"] = "MACULA Greek Linguistic Datasets, available at https://github.com/Clear-Bible/macula-hebrew/blob/main/WLC/lowfat"
    generic["dataSourceLocation"] = "https://github.com/sergeypanfilov[tobecreated]/tflxx[tobecreated]/tree/main/xml/2025-02-05/mt-sync-lxx"
    generic["version"] = tfVersion
    generic["xmlVersion"] = xmlVersion
    generic["xmlSourceDate"] = "April 9, 2024"
